...
# configure.sh
# This script is used to configure the macOS installer for the ArcGIS Maps SDK for Qt.
...
function _display_help() {
  ...
  echo "          Optional"
  echo
  echo " -u Uninstall ArcGIS Maps SDK for Qt macOS."
  echo "          Optional"
  echo
  echo " -a, --accept-eula Accept the EULA for headless installs."
  echo "          Optional"
  echo
  echo "Example: To configure the ArcGIS Maps SDK for Qt for macOS"
  echo
  echo " ./configure.sh"
  echo
  echo "================================================================================"
...
function install_() {
  ...
  if [[ $RUN_POST_INSTALL == true ]]; then
    ...
    log_ "Post install is successful."
  fi
